...
FILE *fichier1;
fichier1=fopen("../results/results_mkl_gemm_fp32.dat","w");
...
alpha=(MKL_Complex8*)calloc(1,sizeof(MKL_Complex8));
beta=(MKL_Complex8*)calloc(1,sizeof(MKL_Complex8));
...
A=(MKL_Complex8*)calloc(M*N,sizeof(MKL_Complex8));
B=(MKL_Complex8*)calloc(M*N,sizeof(MKL_Complex8));
C=(MKL_Complex8*)calloc(M*N,sizeof(MKL_Complex8));
...
cgemm(&transa,&transb,&dim,&dim,&dim,alpha,A,&dim,B,&dim,beta,C,&dim);
